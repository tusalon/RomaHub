...
-- Ejecutar en Supabase SQL Editor antes de desplegar las Edge Functions nuevas.

-- 1) Las contraseñas dejan de almacenarse. Los códigos de recuperación se
-- guardan únicamente como SHA-256 con un secreto del servidor.
...
-- 2) Límite de solicitudes. Solo las Edge Functions con service_role pueden
-- usar esta tabla y esta función; la IP se almacena como hash, nunca en claro.
...
-- 3) El dueño edita todo su perfil si es una tienda externa. Los negocios de
-- Rservasroma conservan nombre, WhatsApp, logo y ubicación administrados desde
-- Rservasroma; aquí solo editan descripción y encuadre de portada.
