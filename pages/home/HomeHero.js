  ...
  try {
    ...
    return (
      <section className="relative overflow-hidden pt-11 md:pt-6 pb-2" data-name="home-hero" data-file="pages/home/HomeHero.js">
        ...
        <a
          className="absolute top-3 right-3 md:top-6 md:right-8 z-20 inline-flex items-center gap-1 whitespace-nowrap px-2.5 py-1.5 md:px-3.5 md:py-2 rounded-full bg-white/90 backdrop-blur border border-[var(--border)] text-[11px] md:text-xs font-bold text-[#261D29] hover:text-[#681831] hover:border-[#681831]/40 transition-colors shadow-sm"
        ...
        <div className="container-rr relative grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 lg:gap-6 items-center" data-name="home-hero-inner" data-file="pages/home/HomeHero.js">
          <div className="max-w-3xl hero-anim-rr" data-name="home-hero-copy" data-file="pages/home/HomeHero.js">
            ...
            <div className="inline-flex items-center gap-1.5 mb-3 px-3 py-1.5 rounded-full bg-[rgba(104,24,49,0.08)] border border-[rgba(104,24,49,0.18)]" data-name="hero-launch-badge" data-file="pages/home/HomeHero.js">
              <span aria-hidden="true">🎉</span>
              <span className="text-xs font-bold text-[#681831]" data-name="hero-launch-badge-text" data-file="pages/home/HomeHero.js">Recién inaugurado</span>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-[64px] font-black tracking-[-0.025em] leading-[1.02] text-[#261D29]" data-name="hero-title" data-file="pages/home/HomeHero.js">
              ...
              <span className="relative inline-block text-[#681831]" data-name="hero-title-accent" data-file="pages/home/HomeHero.js">
                ...
                <svg
                  ...
                  data-file="pages/home/HomeHero.js"
                >
                  <path d="M2 9 C 50 2, 150 2, 198 9" stroke="#681831" strokeWidth="6" strokeLinecap="round" fill="none" opacity="0.3" />
                </svg>
              </span>
            </h1>
            ...
            <div className="mt-8 max-w-[760px]" data-name="hero-search" data-file="pages/home/HomeHero.js">
              ...
              <button
                className="mt-3 text-sm font-semibold text-[var(--text-muted)] hover:text-[#681831] transition-colors inline-flex items-center gap-1.5"
          ...
          <div className="relative mx-auto w-full max-w-[300px] lg:max-w-full" data-name="hero-visual" data-file="pages/home/HomeHero.js">
            <a
              className="group block relative rounded-[22px] lg:rounded-[28px] border border-[var(--border)] bg-white shadow-[0_16px_40px_rgba(38,29,41,0.12)] lg:shadow-[0_24px_60px_rgba(38,29,41,0.12)] overflow-hidden"
              href="search.html"
              data-name="hero-visual-frame"
              data-file="pages/home/HomeHero.js"
            >
              <div className="relative h-[220px] lg:h-[300px] bg-[#F6EEE6] overflow-hidden" data-name="hero-visual-cover" data-file="pages/home/HomeHero.js">
                ...
                <span className="absolute top-3 left-3 inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-white/95 backdrop-blur text-[11px] font-bold text-[#681831] shadow-sm" data-name="hero-visual-kicker" data-file="pages/home/HomeHero.js">
              ...
              <div className="p-4 flex items-center justify-between gap-3" data-name="hero-visual-footer" data-file="pages/home/HomeHero.js">
                ...
                <span className="text-xs font-bold text-[#681831] inline-flex items-center gap-1 shrink-0" data-name="hero-visual-cta" data-file="pages/home/HomeHero.js">
                  Ver directorio
            ...
            <div className="mt-3 mx-2 lg:mx-4 surface-rr px-3 py-2 lg:px-4 lg:py-3 flex items-center gap-2 shadow-[0_12px_28px_rgba(38,29,41,0.14)]" data-name="hero-visual-badge" data-file="pages/home/HomeHero.js">
              ...
              <div data-name="hero-visual-badge-copy" data-file="pages/home/HomeHero.js">
                ...
                <p className="text-xs lg:text-sm font-bold text-[#261D29] leading-none" data-name="hero-visual-badge-title" data-file="pages/home/HomeHero.js">{totalBusinesses} negocios con servicios publicados</p>
