  ...
  try {
    ...
    return (
      <div className="surface-rr overflow-hidden" data-name="romahub-upgrade-promo" data-file="components/RomaHubUpgradePromo.js">
        <div className="relative h-28 overflow-hidden bg-[#F6EEE6]" data-name="upgrade-promo-media" data-file="components/RomaHubUpgradePromo.js">
          <img
            loading="lazy"
            decoding="async"
        ...
        <div className="p-4" data-name="upgrade-promo-body" data-file="components/RomaHubUpgradePromo.js">
          <p className="text-sm font-bold text-[#261D29] leading-snug" data-name="upgrade-promo-title" data-file="components/RomaHubUpgradePromo.js">
