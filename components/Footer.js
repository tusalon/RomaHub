function Footer() {
  try {
    ...
    return (
      <footer className="border-t border-[var(--border)] bg-[#261D29]" data-name="footer" data-file="components/Footer.js">
                ...
                <ul className="space-y-2.5" data-name="footer-col-list" data-file="components/Footer.js">
                  {columna.enlaces.map((enlace) => (
                    <li key={enlace.texto} data-name="footer-col-item" data-file="components/Footer.js">
                      <a
                        className="text-xs text-gray-400 hover:text-[#681831] transition-colors"
                        href={enlace.href}
